        ...
        <div className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-background">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-6">
                    ...
                    <h1 className="text-4xl font-black text-white mb-2 tracking-tight uppercase text-center leading-tight">Join the Ecosystem</h1>
                ...
                {/* Signup Card */}
                <div className="bg-black/40 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-8 md:p-10 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full py-4 bg-primary text-white font-bold rounded-2xl hover:bg-orange-600 transition-all shadow-[0_10px_30px_rgba(255,87,34,0.3)] hover:shadow-[0_15px_40px_rgba(255,87,34,0.5)] flex items-center justify-center gap-3 group mt-6 uppercase tracking-widest text-sm"
                        >
                            Create Identity
