...
import {
    LayoutDashboard, Search, Trophy, Calendar, Building2,
    Briefcase, Handshake, MessageSquare, Settings, LogOut,
    Menu, X, Bell, User as UserIcon, CheckCircle2, ChevronRight,
    MapPin, Globe, Star
} from "lucide-react";
...
const SIDEBAR_LINKS = [
    ...
    { name: "Explore Athletes", href: "/user/athletes", icon: Search },
    { name: "Leaderboard", href: "/user/leaderboard", icon: Trophy },
    { name: "Events", href: "/user/events", icon: Calendar },
    { name: "Academies", href: "/user/academies", icon: Building2 },
    { name: "Opportunities", href: "/user/opportunities", icon: Briefcase },
    { name: "Sponsorships", href: "/user/sponsorships", icon: Handshake },
                ...
                <header className="h-20 bg-black/20 border-b border-white/5 flex items-center justify-between px-6 lg:px-10 z-30">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative group hidden md:block">
                            ...
                            <input
                                type="text"
                                placeholder="Search athletes, events, or scouts..."
                        ...
                        <div className="flex items-center gap-3 pl-4 border-l border-white/10">
                            <div className="text-right hidden sm:block">
                                <p className="text-xs font-black uppercase tracking-wider text-white leading-tight">
                                    {user?.displayName || "Public User"}
                                </p>
                                <div className="flex items-center justify-end gap-1 mt-0.5">
                                    <Star size={10} className="text-primary fill-primary" />
                                    <span className="text-[9px] font-bold text-gray-500 uppercase tracking-widest leading-none">VIP Member</span>
                                </div>
                            </div>
