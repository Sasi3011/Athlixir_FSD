...
import {
    LayoutDashboard, Users, Activity, Flame, BarChart3,
    Calendar, MessageSquare, Briefcase, Settings, LogOut, Search, Bell, Menu, X,
...
const SIDEBAR_LINKS = [
    ...
    { name: "My Athletes", href: "/coach/athletes", icon: Users },
    { name: "Performance Monitoring", href: "/coach/performance", icon: Activity },
    { name: "Injury Reports", href: "/coach/injury", icon: Flame },
    { name: "Team Analytics", href: "/coach/team-analytics", icon: BarChart3 },
    { name: "Events Management", href: "/coach/events", icon: Calendar },
    { name: "Messages", href: "/coach/messages", icon: MessageSquare },
    { name: "Opportunities Posted", href: "/coach/opportunities", icon: Briefcase },
...
const CoachLayout = () => {
    ...
    const userRole = user ? localStorage.getItem(`role_${user.uid}`) || 'coach' : 'coach';
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white flex overflow-hidden font-sans">
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 pl-4 border-l border-white/10">
                            ...
                            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-orange-600 p-[1px]">
                                <div className="w-full h-full rounded-xl bg-black flex items-center justify-center text-primary font-black uppercase overflow-hidden border border-white/10 shadow-lg font-mono">
                                    {user?.photoURL ? (
                ...
                {/* Content Outlet */}
                <main className="flex-1 overflow-y-auto p-6 lg:p-10 scrollbar-hide bg-[#080808]">
                    <Outlet />
                </main>
            </div>
