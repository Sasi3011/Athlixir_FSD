    ...
    >
      <div className="container mx-auto px-6 lg:px-12 flex items-center justify-between h-full">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          <button
            className={`px-6 py-2.5 text-xs font-semibold uppercase tracking-wider border rounded-full transition-all ${
              isScrolled
          ...
          <button className="px-6 py-2.5 text-xs font-bold uppercase tracking-wider bg-primary text-white rounded-full hover:bg-orange-600 transition-all shadow-[0_0_15px_rgba(255,87,34,0.3)] hover:shadow-[0_0_20px_rgba(255,87,34,0.5)]">
            Get Started
          </button>
        </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="flex flex-col space-y-6">
              ...
              <button className="w-full py-3 border border-white/20 rounded-lg text-white uppercase text-xs">
                Login
              </button>

              <button className="w-full py-3 bg-primary text-white rounded-lg uppercase text-xs">
                Get Started
              </button>
            </div>
          </motion.div>
